                  ...
                  <ul class="cart-list">
                    ...
                    ?>
                        <li>
                            ...
                            <p><span class="price"><?php echo $cart[$i]->proPrice ?></span></p>

                            <?php error_reporting(0); $total += $cart[$i]->proPrice ?>
                        </li>
                    <?php }?>
                    <li class="total">
                            <a href="viewCart.php" class="btn btn-default hvr-hover btn-cart">VIEW CART</a>
                    ...
                    <div class="products-single fix">
                        ...
                        <img src="<?php echo $products[$i]->image ?>" class="img-fluid" alt="Image">
                            <div class="mask-icon" style='display: flex'>
                                ...
                                <form method="post">
                                <button class="cart" name='cart' value =<?php echo $products[$i]->id?>>Add to Cart</button>
                                </form>
                            </div>
                        </div>
                        <div class="why-text">
